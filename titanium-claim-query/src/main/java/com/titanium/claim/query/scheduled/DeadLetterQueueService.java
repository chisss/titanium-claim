 ...
 * <p>
 * 定时扫描理赔读侧投影处理组的死信队列，重试因事件乱序等原因投影失败的事件序列。 处理组名须与
 * {@link com.titanium.claim.query.handler.projection.ClaimProjectionEventHandler} 的
...
public class DeadLetterQueueService {
    ...
    /** 投影处理组名，与 ClaimProjectionEventHandler 的 @ProcessingGroup 一致 */
    private static final String PROCESSING_GROUP = "claim-query-group";
